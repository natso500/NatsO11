...
$Id: $
 ...
 print " | $$  \ $$ | $$  | $$| $$| $$  | $$| $$_____/| $$  | $$| $$      | $$  | $$| $$_____/ "
 print " |  $$$$$$/ |  $$$$$$/| $$|  $$$$$$$|  $$$$$$$| $$  | $$| $$$$$$$$|  $$$$$$$|  $$$$$$$ "
 print " \______/   \______/ |__/ \_______/ \_______/|__/  |__/|________/ \____  $$ \_______/
 print "                                                                    /$$  | $$          "
 print "                                                                   |  $$$$$$/          "
 print "                                                              
...
class GoldenEye(object):
    ...
    def fire(self):
        ...
        self.printHeader()
        print "Hitting webserver in mode  with 10 workers running "
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print "".format(self.counter[0], self.counter[1])
